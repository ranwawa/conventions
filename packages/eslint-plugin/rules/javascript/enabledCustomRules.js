...
module.exports = {
  ...
  "@awawa/no-buffer-constructor": "error",
  ...
  "@awawa/no-shadow-restricted-names": "error",
  "@awawa/no-shadow": "error",
  ...
  "@awawa/no-undef-init": "error",
  "@awawa/no-undef": "error",
  ...
  "@awawa/no-unused-vars": [
    "error",
    { vars: "all", args: "after-used", ignoreRestSiblings: true },
  ],
  "@awawa/no-use-before-define": [
    "error",
