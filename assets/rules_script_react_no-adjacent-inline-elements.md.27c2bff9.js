import{_ as s,c as n,o as a,a as l}from"./app.71c7e370.js";const A=JSON.parse('{"title":"no-adjacent-inline-elements","description":"","frontmatter":{},"headers":[{"level":3,"title":"正确示例","slug":"正确示例","link":"#正确示例","children":[]},{"level":3,"title":"参考","slug":"参考","link":"#参考","children":[]}],"relativePath":"rules/script/react/no-adjacent-inline-elements.md","lastUpdated":1676798319000}'),p={name:"rules/script/react/no-adjacent-inline-elements.md"},o=l(`<h1 id="no-adjacent-inline-elements" tabindex="-1">no-adjacent-inline-elements <a class="header-anchor" href="#no-adjacent-inline-elements" aria-hidden="true">#</a></h1><p>禁止不必要的 fragments</p><p>why?</p><p>避免代码冗余</p><blockquote><p>bad</p></blockquote><div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#89DDFF;">&lt;&gt;{</span><span style="color:#A6ACCD;">foo</span><span style="color:#89DDFF;">}&lt;/&gt;</span></span>
